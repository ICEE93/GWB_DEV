...
local module = {}
module.name = "Classic_Human_Warlock_1-10"
...
local function _update()
    ...
    restHandler.settings.rest_start_mana_percent.value = 50 
    restHandler.settings.rest_stop_mana_percent.value = 80
    restHandler.settings.rest_use_drink.value = true -- Important for casters!
...
module.PlayerCanUse = function()
    ...
    if select(2, UnitClass("player")) ~= "WARLOCK" then return false end
    return true
end
